...
<body>
  ...
  <main>
    <section class="hero">
      ...
      <div class="container">
        <div class="hero__content">
          <h2 class="title hero__title wow fadeInLeft" data-wow-delay="0.1s">Турецкий ремонт в&nbsp;<span class="title--primary">Ростове-на-Дону</span></h2>
          <p class="hero__text wow fadeInRight" data-wow-delay="0.3s">Получите готовый ремонт под ключ в срок с экономией рабочего времени до 45 дней и 20% от стоимости 
          материалов за счет организации работы</p>
          <button class="button hero__button button--primary wow fadeInLeft"data-wow-delay="0.5s" data-toggle="modal">Расчитать стоимость</button>
          <button class="button hero__button button--outline wow fadeInRight"data-wow-delay="0.5s" data-toggle="modal">Отправить заявку</button>
        </div>
        <!-- /.hero__content -->
      </div>
      <!-- /.container -->
      <a href="#" class="hero__scroll-down wow pulse" data-wow-iteration="2" data-wow-delay="3s">листайте вниз</a>
    </section>
    <!-- /.hero -->
    <section class="section section--dark projects">
      <div class="container">
        <div class="section-title section-title--left wow fadeInDown">
          <h2 class="section-title__heading section-title__heading--primary">Завершенные 
            <span class="section-title__word">проекты</span></h2> 
          <!-- /.section-title__heading -->
          <p class="section-title__text section-title__dsp">На сайте представлена ​​лишь небольшая часть работ, выполняемых нашей компанией.
             За 14 лет работы на строительном рынке мы осчастливили более 1000 семей</p>
        </div>
        <div class="row">
          <div class="col-50">
            ...
            <div class="swiper-container">
              ...
              <div class="swiper-wrapper swiper-no-swiping">
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="swiper-slide__text">
                      <h3 class="swiper-slide__heading">Площадь:</h3>
                      <span class="swiper-slide__value swiper-slide__description">81 м <sup>2</sup> </span>
                    </div>
          ...
          <!-- /.col-50 -->
          <div class="col-50 mobile-order-top">
            <!-- Slider main container -->
            <div class="swiper-container swiper-slider-image">
              <!-- Additional required wrapper -->
              <div class="swiper-wrapper swiper-no-swiping">
                  <!-- Slides -->
                  <div class="swiper-slide">
    ...
    <section class="section control">
      <div class="container">
        <div class="section-title control__section-title section-title--light wow fadeInLeft">
          <h2 class="section-title__heading ">Онлайн контроль</h2>
          <!-- /.section-title__heading -->
          <div class="section-title__image">
            <img src="img/video.svg" alt="Камера">
          </div>
        ...
        <form action="#" class="form control__form">
          ...
          <!-- /.button button--primary control__button -->
    ...
    <section class="section types">
      <div class="container">
        <div class="section-title types__section-title">
          <h2 class="section-title__heading wow fadeInRight">Виды ремонта</h2>
          <!-- /.section-title__heading -->
          <div class="section-title__image">
    ...
    <section class="section design">
      <div class="container">
        <div class="section-title design__section-title wow fadeInDown">
          ...
          <p class="section-title__description">
            Дизайн-проект не только помогает сделать ремонт вашей 
            квартиры более современным, но и 
        ...
        <!-- <design__section-title> -->
         ...
         <div class="row">
          <div class="col-30">
            <div class="card design__card wow fadeInLeft">
              <img src="img/design/design-1.jpg" alt="Дизайнерский ремонт" class="card__image">
              <div class="card__text">
                <h3 class="card__title">Дизайнерский ремонт</h3>
                <!-- /.card__title -->
                <ul class="card__list">
          ...
          <!-- /.col -->
          <div class="col-30">
            <div class="card design__card wow fadeInUp">
              <img src="img/design/design-2.jpg" alt="Дизайнерский ремонт" class="card__image">
              <div class="card__text">
                <h3 class="card__title">Дизайнерский ремонт</h3>
                <!-- /.card__title -->
                <ul class="card__list">
          ...
          <!-- /.col -->
            <div class="col-30">
              <div class="card design__card wow fadeInRight">
      ...
      <div class="footer__wrap">
        ...
        <form action="#" class="form footer__form">
          ...
          <div class="input-group footer__input-group">
            ...
            <input type="tel" class="input form__input footer__input input--light"
            id="user-phone" placeholder="Ваш номер телефона:">
          </div>
          ...
          <div class="input-group footer__input-group footer__input-group--full-width">
            ...
            <input type="text" class="input form__input footer__input input--light" 
            id="user-email" placeholder="Я хочу спросить:">
  ...
  <div class="modal ">
    <div class="modal__dialog">
      ...
      <form action="send.php" method="POST" class="form modal__form">
        ...
        <!-- /.button button--primary modal__button -->
      </form>
      <!-- /.form modal__form -->
    </div>
    <!-- /.modal__dialog -->
